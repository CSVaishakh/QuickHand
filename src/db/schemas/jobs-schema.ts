...
export const listed_jobs = pgTable("listed_jobs", {
  ...
  job_category: text("job_category").$type<"plumbing" | "electrical" | "carpentery" | "masonary" | "mechanical" | "havc" | "landscaping" | "cleaning">()
}, (table) => [
...
export const jobs = pgTable("jobs", {
    ...
    job_category: text("worker_category").$type<"plumbing" | "electrical" | "carpentery" | "masonary" | "mechanical" | "havc" | "landscaping" | "cleaning">()
}, (table) => [
