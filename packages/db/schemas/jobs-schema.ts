...
export const listed_jobs = pgTable("listed_jobs", {
  ...
  job_category: text("job_category").$type<"plumbing" | "electrical" | "carpentery" | "masonary" | "mechanical" | "hvac" | "landscaping" | "deep_cleaning">().notNull()
}, (table) => [
...
export const jobs = pgTable("jobs", {
    ...
    job_category: text("worker_category").$type<"plumbing" | "electrical" | "carpentery" | "masonary" | "mechanical" | "hvac" | "landscaping" | "deep_cleaning">().notNull()
}, (table) => [
