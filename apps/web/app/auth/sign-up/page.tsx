...
import SignUpHeader from "./_components/header";
import SignUpHero from "./_components/hero";
    ...
    <section className="min-h-screen flex flex-col items-center justify-center bg-blue-400">
        <main className="aspect-13/16 w-140 bg-white border-4 border-black rounded-2xl shadow-2xl flex flex-col ">
            ...
            <div className="text-blue-400 flex justify-center py-2">
                <p>Aldready have an account? <Link href={"/auth/sign-in"}><button>SignIn!</button></Link></p>
            </div>
        </main>
    </section>
  );
